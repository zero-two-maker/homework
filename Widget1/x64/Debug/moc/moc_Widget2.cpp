...
QT_MOC_LITERAL(4, 43, 12) // "my_show_slot"

    },
    "Widget2\0show_mainManue\0\0on_exitbtn_clicked\0"
    "my_show_slot"
};
...
void Widget2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->my_show_slot(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Widget2::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Widget2::show_mainManue)) {
                *result = 0;
                return;
            }
        }
